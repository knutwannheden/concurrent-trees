...
/**
 * Similar to {@link ByteArrayNodeNonLeafNullValue} but with an incoming length of a single character only.
 * <p/>
 ...
 */
public class SingleByteNodeNonLeafNullValue implements Node {
    ...
    public SingleByteNodeNonLeafNullValue(char edgeChar, List<Node> outgoingEdges) {
