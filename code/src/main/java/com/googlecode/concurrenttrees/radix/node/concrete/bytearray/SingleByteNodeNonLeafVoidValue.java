...
/**
 * Similar to {@link ByteArrayNodeNonLeafVoidValue} but with an incoming length of a single character only.
 * <p/>
 ...
 */
public class SingleByteNodeNonLeafVoidValue implements Node {
    ...
    public SingleByteNodeNonLeafVoidValue(char edgeChar, List<Node> outgoingEdges) {
