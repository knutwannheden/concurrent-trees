...
/**
 * Similar to {@link ByteArrayNodeDefault} but with an incoming length of a single character only.
 * <p/>
 ...
 */
public class SingleByteNodeDefault implements Node {
    ...
    public SingleByteNodeDefault(char edgeChar, Object value, List<Node> outgoingEdges) {
