...
import com.googlecode.concurrenttrees.radix.node.concrete.bytearray.ByteArrayCharSequence.IncompatibleCharacterException;

import java.util.Collections;
import java.util.List;

/**
 * Similar to {@link ByteArrayNodeLeafWithValue} but with an incoming length of a single character only.
 * <p/>
 ...
 */
public class SingleByteNodeLeafWithValue implements Node {
    ...
    public SingleByteNodeLeafWithValue(char edgeChar, Object value) {
